...
- Source document: `FEC Type AA - Lattice Tower Audit Sheets.pdf`.
- Accessed: 2026-06-29.
- The source PDF and its extraction pack are retained in the private engineering evidence library and are not part of the public site artifact.
